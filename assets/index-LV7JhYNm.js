...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function Xu(){return new di({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ci,depthTest:!1,depthWrite:!1})}function qu(){return new di({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
